...
//@JonManagedReference = lo usamos cuando construimos una API donde hay una lista
//@JsonBackReference = lo usamos cuando construimos una API donde hay un objeto
//@JsonIgnore = ignora la relación y construye la API sin la información
