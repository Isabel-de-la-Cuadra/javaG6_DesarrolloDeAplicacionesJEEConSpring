				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					<div class="card shadow-lg" style="background-color: #f6fa04">
						<div class="card-body p-5">
							<h1 class="fs-4 card-title fw-bold mb-4">Formulario de Registro de Clientes</h1>
							...
							<form:form  method="POST" action="/cliente" modelAttribute="cliente">
								...
								<div class="mb-3">
									...
									<form:input type="email" class="form-control" path="correo"
										value="" placeholder="Ingresa el correo electrónico del cliente" />
				...
				<tbody>
					<c:forEach var="cliente" items="${listaClientes}">
						<tr>
							...
							<td><a class="btn btn-primary" href="/cliente/editar/${cliente.id}" role="button">Editar</a>
								<a class="btn btn-danger" href="/cliente/eliminar/${cliente.id}" role="button">Eliminar</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
